# Импортируем необходиные модули и функции
...
class Arena(metaclass=BaseSingleton):
    ...
    battle_result: None = None

    def start_game(self: None, player: BaseUnit, enemy: BaseUnit) -> None:
    ...
    def _check_players_hp(self) -> Any:
